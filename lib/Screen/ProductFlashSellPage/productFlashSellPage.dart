...
import 'package:ecommerce_bokkor_dev/Screen/FlashSell/AllflashCard.dart';
...
import 'package:ecommerce_bokkor_dev/model/FlashAllModel/flashAllModel.dart';
import 'package:ecommerce_bokkor_dev/model/SubCategoryModel/subCategoryModel.dart';
import 'package:flutter/material.dart';
import 'package:flutter_i18n/flutter_i18n.dart';
import 'package:shared_preferences/shared_preferences.dart';

class ProductFlashSellPage extends StatefulWidget {
  final id;

  ProductFlashSellPage(this.id);
  @override
  _ProductState createState() => _ProductState();
}

class _ProductState extends State<ProductFlashSellPage> {
  ...
  Future<void> getFilterData() async {
    ...
    var res = await CallApi().getData(
        '/app/showFlashsaleProductfilter/${widget.id}?max=${maxController.text}&min=${minController.text}&cat=$cat&sub=$subCat&ordercoloum=$orderName&ordersort=$orderType&searchtext=$search');
  ...
  void _getFilterlist() {
    var newFilter = FlashAllModel.fromJson(body);
    if (!mounted) return;
    setState(() {
    ...
    return Scaffold(
      appBar: new AppBar(
        ...
        title: isSearch == false
            ? Text(FlutterI18n.translate(context,"Flash_Sale"))
            : Container(
                height: 50.0,
          ...
          : filterList.length == 0
              ? Stack(
                  children: <Widget>[
                    Center(
                      child: Container(
                        child: Text(FlutterI18n.translate(context,"No products found"+"!")),
                      ),
                    ),
                    isFilter == false
                        ? Container()
                          ...
                          Container(
                            ...
                            child: GridView.builder(
                              ...
                              itemBuilder: (BuildContext context, int index) =>
                                ...
                                child:
                                    AllFlashSellCard(user, filterList[index]),
                              ),
