...
class ProductAllSearchPage extends StatefulWidget {
  @override
  _ProductState createState() => _ProductState();
}

class _ProductState extends State<ProductAllSearchPage> {
    ...
    return Scaffold(       
      appBar: new AppBar(  
        ...
        title: isSearch == false
            ? Text(FlutterI18n.translate(context, "All_Products"))
            : Container(
                height: 50.0,
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      Text(
                                                          nameOrder == ""
                                                              ...
                                                              : FlutterI18n.translate(context, nameOrder),
                                                          maxLines: 1,
                                                          overflow: TextOverflow
                                                              .ellipsis,
                                                          style: TextStyle(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      Text(
                                                          typeOrder == ""
                                                              ...
                                                              : FlutterI18n.translate(context, typeOrder),
                                                          style: TextStyle(
                                                              fontSize: 12,
                                                              color: orderType ==
                                                                      ""
                            ...
                            child: Column(
                              children: <Widget>[
                                Container(
                                    ...
                                    child: new Text(FlutterI18n.translate(context, "Sub-Category"))),
                                Divider(
                                  height: 0,
                                  color: Colors.grey[400],
                                ),
        ...
        onTap: () {
          setState(() {
           if (name == FlutterI18n.translate(context,"ID")) {
            ...
            else if(name==FlutterI18n.translate(context,"Price")){
              orderName = "price";
            }
