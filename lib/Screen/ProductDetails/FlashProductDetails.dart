...
class FlashProductDetails extends StatefulWidget {
  final id;
  final quantity;
  FlashProductDetails(this.id, this.quantity);
  @override
  State<StatefulWidget> createState() {
    return FlashProductDetailsState();
  }
}         

class FlashProductDetailsState extends State<FlashProductDetails>
  ...
  void _productsDetailsState() {
    ...
    setState(() {
      ...
      // if (flashCheck[0].product.quantity == 0) {
       _isPreorder = true;
       }
                      ...
                      children: <Widget>[
                                  ...
                                  setState(() {
                                    if (_isLoggedIn) {
                                     ...
                                     // if (quantity > detailsProduct[0].stock) {
                                      if (quantity > flashCheck[0].product.quantity) {
                                        _isPreorder = true;
                                      }
                        ...
                        Container(
                          ...
                          //  "${detailsProduct[0].stock}"+FlutterI18n.translate(context,"Available") ,
                            flashCheck==null?
                            "0 "+FlutterI18n.translate(context,"Available"):
                            "${flashCheck[0].product.quantity - flashCheck[0].product.totalSale} "+FlutterI18n.translate(context,"Available") ,
                            style: TextStyle(
        ...
        for (int i = 0; i < detailsProduct[0].product_vc.length; i++) {
          if (detailsProduct[0].product_vc[i].combination == com &&
            ...
            setState(() {
              ...
              print("combinationnnnnnnnnnnnnnnn");
              print(combination);
              // print("stock");
              // print(stock);
            });
          ...
          Flexible(
            ...
            child: GestureDetector(
              onTap: () {
                ...
                print(quantity);
                print(flashCheck[0].product.quantity);
                print(flashCheck[0].product.totalSale);
                print(flashCheck[0].product.quantity-flashCheck[0].product.totalSale);
               // print(quantity+flashCheck[0].product.totalSale>);
              
                setState(() {
                  if (_isLoggedIn) {
                    if (quantity > flashCheck[0].product.quantity ||
                        (quantity + flashCheck[0].product.totalSale)>flashCheck[0].product.quantity) {
                  ...
                  child: !_isadd
                      ...
                      : Container(
                          ...
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: <Widget>[
                             quantity > flashCheck[0].product.quantity ||
                              (quantity + flashCheck[0].product.totalSale)>flashCheck[0].product.quantity?
                              Container(): Container(
                                  padding: EdgeInsets.only(
  ...
  void _storeData() async {
    ...
    //  int stock = detailsProduct[0].stock;
      int stock = flashCheck[0].product.quantity;
