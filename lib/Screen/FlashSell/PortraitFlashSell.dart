...
class PortraitFlashSellCard extends StatefulWidget {
  final user;
  final index;

  PortraitFlashSellCard(this.user, this.index);
  @override
  _PortraitFlashSellCardState createState() => _PortraitFlashSellCardState();
}

class _PortraitFlashSellCardState extends State<PortraitFlashSellCard> {
  int hours = 0, discout = 0, sold = 0, stock = 0;
  double dSold = 0.0, discount = 0.0, price = 0.0, totalSold = 0.0;
      ...
      child: GestureDetector(
        ...
        onTap: () {
          Navigator.push(
            ...
            MaterialPageRoute(
                builder: (context) =>
                    FlashProductDetails(widget.index.productId, 1)),
                   // ProductsDetailsPage(widget.index.productId, 1)),
          );
        },
        child: ListTile(
                                ...
                                child: Row(
                                  children: <Widget>[
                                    ...
                                    Padding(
                                      ...
                                      child: Text(
                                          "${totalSold.toStringAsFixed(2)}% "+FlutterI18n.translate(context, "Sold"),
                                          maxLines: 1,
                                          overflow: TextOverflow.ellipsis,
                                          style: TextStyle(
                                              fontSize: 8,
