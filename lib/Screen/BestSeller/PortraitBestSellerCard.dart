...
class PortraitBestSellerCard extends StatefulWidget {
  final user;
  final index;
  PortraitBestSellerCard(this.user, this.index);
  @override
  _PortraitBestSellerCardState createState() => _PortraitBestSellerCardState();
}

class _PortraitBestSellerCardState extends State<PortraitBestSellerCard> {
