...
class _ProductState extends State<ProductFeaturePage> {
  ...
  Future<void> getFilterData() async {
    ...
    var res = await CallApi().getData(
        '/app/showFeaturedProductfilter?max=${maxController.text}&min=${minController.text}&cat=$cat&sub=$subCat&ordercoloum=$orderName&ordersort=$orderType&searchtext=$search');
    ...
    return Scaffold(
      appBar: new AppBar(
        ...
        title: isSearch == false
            ? Text(FlutterI18n.translate(context, "Featured_Product"))
            : Container(
                height: 50.0,
                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      mainAxisAlignment:
                                          MainAxisAlignment.start,
                                      children: <Widget>[
                                        typeList( nameOrder=="Name"?"A - Z":"First to Last"),
                                          typeList( nameOrder=="Name"?"Z - A":"Last to First"),
                                      ],
                                    ),
                                  ),
                                ),
