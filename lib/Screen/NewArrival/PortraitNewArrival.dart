...
class ProtraitNewArrivalCard extends StatefulWidget {
  final user;
  final index;
  ProtraitNewArrivalCard(this.user, this.index);
  @override
  _ProtraitNewArrivalCardState createState() => _ProtraitNewArrivalCardState();
}

class _ProtraitNewArrivalCardState extends State<ProtraitNewArrivalCard> {
  double rating = 0.0, discPrice = 0.0;
                          ...
                          children: <Widget>[
                            Container(
                              ...
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: <Widget>[
                                  Text(FlutterI18n.translate(context, "Product_id"),
                                    maxLines: 1,
