...
//   final id;
//   PreorderDetails(this.id);
//   @override
//   State<StatefulWidget> createState() {
//     return PreorderDetailsPageState();
//   }
// }

// class PreorderDetailsPageState extends State<PreorderDetails>
...
//       last = 1,
//       first = 1;
//   int c1 = 0, c2 = 0, idx = 0, quantity = 0;
...
//     var detProducts = PreorderModel.fromJson(body);
//     print(body);
//     if (!mounted) return;
//     setState(() {
//       detailsProduct = detProducts.reservation;

//       print("detailsProduct[0].product.photo.length");
//       print(detailsProduct[0].product.photo.length);

//       print("detailsProduct[0].product.video.length");
//       print(detailsProduct[0].product.video.length);
...
//     if (token == null) {
//       var res =
//           await CallApi().getData('/app/showSingleReservation/${widget.id}');
...
//           .getData('/app/showSingleReservation/${widget.id}?token=$token');
//       body = json.decode(res.body);
//       if (res.statusCode == 200) {
//         _productsDetailsState();
//       }
...
//           children: <Widget>[
//             Text(
//               FlutterI18n.translate(context,"Product Details"),
...
//             ),
//             Text(
//               "${selectedSize.length}"+ FlutterI18n.translate(context,"available sizes") ,
//               style: TextStyle(
...
//                               Container(
//                                   margin: EdgeInsets.only(left: 5),
//                                   child: Text(FlutterI18n.translate(context, "View Cart"),
//                                       style: TextStyle(
//                                         color: appTealColor,
//                                         //fontSize: 17
//                                       ))),
