...
class ProductBestSellPage extends StatefulWidget {
  @override
  _ProductState createState() => _ProductState();
}

class _ProductState extends State<ProductBestSellPage> {
  ...
  Future<void> getFilterData() async {
    ...
    var res = await CallApi().getData(
        '/app/showBestSellerProductfilter?max=${maxController.text}&min=${minController.text}&cat=$cat&sub=$subCat&ordercoloum=$orderName&ordersort=$orderType&searchtext=$search');
    ...
    return Scaffold(
      appBar: new AppBar(
        ...
        title: isSearch == false
            ? Text(FlutterI18n.translate(context, "Best_Seller"))
            : Container(
                height: 50.0,
                                                  ...
                                                  minController.text == "" &&
                                                      ...
                                                      : minController.text ==
                                                              ...
                                                              maxController
                                                                      .text !=
                                                                  ""
                                                          ? FlutterI18n.translate(context,"Total_Price")+": ${maxController.text}"
                                                          : minController.text !=
                                                                      "" &&
                                                                  maxController
                                                                          .text ==
