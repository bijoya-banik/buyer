...
class OrderHistoryCardDetails extends StatefulWidget {
  final orderData;
  OrderHistoryCardDetails(this.orderData);
  @override
  _OrderHistoryCardDetailsState createState() =>
      _OrderHistoryCardDetailsState();
}

class _OrderHistoryCardDetailsState extends State<OrderHistoryCardDetails> {
  String isReviewd = "";

  @override
  void initState() {
    print(widget.orderData.used_vaoucher);
    setState(() {
                            ...
                            child: Container(
                              ...
                              child: Row(
                                children: <Widget>[
                                  ...
                                  Text(
                                   widget.orderData.used_vaoucher.voucher.code==null?"": " ${widget.orderData.used_vaoucher.voucher.code}"+
                    ...
                    Container(
                      child: Column(
                        ...
                        widget.orderData.used_vaoucher==null?Container():   Container(
                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                ...
                                Container(
                                  ...
                                  margin: EdgeInsets.only(right: 10),
                                  child: Text(
                                   widget.orderData.used_vaoucher.voucher.discount==null?"0%" :"${widget.orderData.used_vaoucher.voucher.discount.toString()} %",
                                    textAlign: TextAlign.left,
                                    style: TextStyle(
                                        color: Colors.black,
                                        fontFamily: "DINPro",
                          ...
                          //////Discount fee end//////
                        //  widget.orderData.tax==null?Container():   Container(
                        //     margin: EdgeInsets.only(bottom: 5),
                        //     width: MediaQuery.of(context).size.width,
                        //     child: Row(
                        //       mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: List.generate(
                          ...
                          return OrderItem(
                              widget.orderData.orderdetails[index], isReviewd);
                        }),
                      ),
                    ),
