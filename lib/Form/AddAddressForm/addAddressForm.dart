...
class _AddAddressFormState extends State<AddAddressForm> {
  ...
  void _getUserInfo() async {
    ...
    countryController.text = 'Bahrain';
   // mobileController.text = phoneCodeNum;
    ...
    return Container(
      child: Column(
        children: <Widget>[
          ...
          editinfo("Address_Name", '', nameController, TextInputType.text, true),

           Container(
              margin: EdgeInsets.only(top: 20), height: 2, child: Divider()),
            
         // editinfo('Mobile', '', mobileController, TextInputType.number, true),
Container(
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  Container(
                      ...
                      child: Text(_isLoading ? FlutterI18n.translate(context, "Please_wait")+("...") : FlutterI18n.translate(context, "Add"),
  ...
  void _updateProfile() async {
    ...
    else if (phoneCodeNum == "") {
      return _showMsg("Country_code_is_empty");
    } 
    ...
    var res = await CallApi()
        .postData(data, '/app/addDeliveryAddress?token=$usertoken');
